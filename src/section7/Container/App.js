...
class App extends React.Component {
	...
	state = {
		...
		girls: [
			...
			},
			{
				...
				name: 'rose',
				img:
					'https://lh3.googleusercontent.com/Cemshv5lxKe5Nipynz7UdagOq7IEzkKovoggRFbMdAhm0yGqQAcfiIH7iy09UxKkjCU-v6U7xLq92ES7xACgORanDNK7qEQz9A=w1600-rj'
			}
		]
	};
	...
	clickHandler = () => {
		this.setState({
			//!Gaboleh begini karena nilai dari previous state nya dapat berbeda dari yang diharapkan
	...
	render() {
		...
		if (this.state.showGirls) {
			show = <Girls girls={this.state.girls} delete={this.deleteClickHandler} change={this.changeInputHandler} />;
		}
